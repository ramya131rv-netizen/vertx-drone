      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10 pt-24 pb-12">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5">
            <img src={logo} alt="VERTX" className="h-14 w-auto invert brightness-0" />
            <p className="mt-6 text-md text-muted-foreground max-w-sm leading-relaxed">
          ...
          <div className="lg:col-span-3">
            <p className="text-[12px] uppercase tracking-[0.4em] text-ember mb-5">Studio</p>
          ...
          <div className="lg:col-span-2">
            <p className="text-[12px] uppercase tracking-[0.4em] text-ember mb-5">Shows</p>
            <ul className="space-y-3 text-md text-muted-foreground">
          ...
          <div className="lg:col-span-2">
            <p className="text-[12px] uppercase tracking-[0.4em] text-ember mb-5">Contact</p>
            <ul className="space-y-3 text-md text-muted-foreground">
              <li>fly@vertx.in</li>
